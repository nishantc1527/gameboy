...
const CpuOp cpu_ops[256] = {
  ...
  op_D0, op_D1, op_D2, op_xx, op_D4, op_D5, op_D6, op_D7,
  op_D8, op_D9, op_DA, op_xx, op_DC, op_xx, op_DE, op_DF,
  op_E0, op_E1, op_E2, op_xx, op_xx, op_E5, op_E6, op_E7,
  op_E8, op_E9, op_EA, op_xx, op_xx, op_xx, op_EE, op_EF,
  op_F0, op_F1, op_F2, op_F3, op_xx, op_F5, op_F6, op_F7,
  op_F8, op_F9, op_FA, op_FB, op_xx, op_xx, op_FE, op_FF,
};
