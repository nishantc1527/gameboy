...
int step(struct Cpu* cpu, Mmu* mmu, uint8_t disassemble_enable,
  ...
  if (instr == 0xCB) {
    ...
    switch (prfx) {
      ...
      case 0x46: c_bit(cpu, mmu_r_mem(mmu, gt_HL(cpu)), 0); return 12;
      ...
      case 0x4E: c_bit(cpu, mmu_r_mem(mmu, gt_HL(cpu)), 1); return 12;
      ...
      case 0x56: c_bit(cpu, mmu_r_mem(mmu, gt_HL(cpu)), 2); return 12;
      ...
      case 0x5E: c_bit(cpu, mmu_r_mem(mmu, gt_HL(cpu)), 3); return 12;
      ...
      case 0x66: c_bit(cpu, mmu_r_mem(mmu, gt_HL(cpu)), 4); return 12;
      ...
      case 0x6E: c_bit(cpu, mmu_r_mem(mmu, gt_HL(cpu)), 5); return 12;
      ...
      case 0x76: c_bit(cpu, mmu_r_mem(mmu, gt_HL(cpu)), 6); return 12;
      ...
      case 0x7E: c_bit(cpu, mmu_r_mem(mmu, gt_HL(cpu)), 7); return 12;
    ...
    switch (instr) {
      ...
      case 0x86: c_add(cpu, mmu_r_mem(mmu, gt_HL(cpu))); return 8;
      ...
      case 0x8E: c_adc(cpu, mmu_r_mem(mmu, gt_HL(cpu))); return 8;
      ...
      case 0x96: c_sub(cpu, mmu_r_mem(mmu, gt_HL(cpu))); return 8;
      ...
      case 0x9E: c_sbc(cpu, mmu_r_mem(mmu, gt_HL(cpu))); return 8;
      ...
      case 0xA6: c_and(cpu, mmu_r_mem(mmu, gt_HL(cpu))); return 8;
      ...
      case 0xAE: c_xor(cpu, mmu_r_mem(mmu, gt_HL(cpu))); return 8;
      ...
      case 0xB6: c_or(cpu, mmu_r_mem(mmu, gt_HL(cpu))); return 8;
